...
const FALLBACK_SERVER_CONFIG_GROUPS = [
  {
    ...
    fields: PLAN_ORDER.flatMap((plan) => [
      ...
      },
      {
        ...
        description: `Repository checkouts above this file count stop before graph review for ${PLAN_LABELS[plan]} users.`,
      },
      {
        path: `plans.${plan}.maxRepoBytes`,
        candidates: [`plans.${plan}.maxRepoBytes`],
        label: `${PLAN_LABELS[plan]} repository byte limit`,
        description: `Repository checkouts above this size stop before graph review for ${PLAN_LABELS[plan]} users.`,
      },
    ]),
  },
  {
