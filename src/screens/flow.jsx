              ...
              <>
                <div className="repo-row repo-row-status repo-scan-policy">
                  ...
                  <div className="repo-main">
                    ...
                    <div className="repo-desc">
                      {T(
                        "Pullwise can scan repositories selected in GitHub authorization, with account and repository quota available, and within worker checkout size limits. If a checkout is too large, the scan stops before repository review and shows the measured size.",
                  ...
                  {hasRepositoryLimitEvidence(preflight) && (
                    ...
                    >
                      ...
                      <div className="muted scan-preflight-summary">
                        {preflight.repositoryLimitExceeded
                          ? T(
                              "This checkout exceeded the worker limits, so repository review was not run.",
