...
- Subscription-plan docs consume the Server's flat provider/model/thinkingLevel
  policy. Do not reconstruct provider-specific nested config or rename Pi
  thinking level back to Codex reasoning effort.
